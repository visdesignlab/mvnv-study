...
function loadBubbleChart(id) {
    $(function () {
        ...
        queue()
                ...
                .defer(d3.json, "data/collegeFake.json")
...
function loadCollegeStructure(data){
    ...
    // Right after filtering, replace with fake college names
    data.forEach(function(college, i) {
        data[i][NAME_ATTR] = fakeCollegeNames[i]
    })
...
var fakeCollegeNames;
function boot(error, data, fakeCollegeNames){

    window.fakeCollegeNames = fakeCollegeNames;
