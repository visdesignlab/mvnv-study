...
(async function() {
  ...
  largeGraphs.map(async graphName=>{
    ...
    let smallGraphSubset = await d3.json("../../data/" + smallGraphPosName);
...
//create large graphs
// (async function() {
//   let graph = await d3.json("../public/twitter_data/Eurovis2019Network.json");

//   let tweets = await d3.json("../public/twitter_data/Eurovis2019Tweets.json");

//   tweets = tweets.tweets;

//   let nodes = await d3.json("../public/data/network_types.json");

//   let config = await d3.json("../../configs/baseConfig.json");

//   // let mds = await d3.json("../public/data/layoutGraphPos.json");
//   let mds = await d3.json("../public/data/network_pos.json")

//   let users = await d3.json("../public/data/userInfo.json");
...
//   //create a barebones graph for layout purposes; 
